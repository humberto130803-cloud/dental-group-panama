...
const reviews = [
  {
    name: 'Maria G.',
    rating: 5,
    text: 'Excelente atencion desde la primera cita. El Dr. Samuel me explico todo el proceso de ortodoncia con mucha paciencia. Estoy encantada con los resultados.',
  ...
  },
  {
    name: 'Carlos R.',
    rating: 5,
    text: 'Me hice el blanqueamiento y quede impresionado con los resultados inmediatos. El equipo es muy profesional y el ambiente es muy comodo.',
  ...
  },
  {
    name: 'Ana L.',
    rating: 5,
    text: 'Lleve a mi hija de 6 anos y la Dra. Aurora fue increible. Mi hija salio feliz y sin miedo. Los Magos de la Sonrisa hacen magia de verdad.',
  ...
  },
  {
    name: 'Roberto M.',
    rating: 5,
    text: 'Las carillas de porcelana que me hizo el Dr. Quiros quedaron naturales y perfectas. Cambiaron mi vida por completo. 100% recomendado.',
  ...
  },
  {
    name: 'Patricia V.',
    rating: 5,
    text: 'Tenia mucho miedo de la cirugia pero el Dr. Enzo Cano me dio total confianza. Todo salio perfecto. Gracias Dental Group!',
    treatment: 'Cirugia Maxilofacial',
    timeAgo: 'Hace 4 meses',
  },
  {
    name: 'Luis F.',
    rating: 5,
    text: 'Invisalign fue la mejor decision. Nadie nota que llevo alineadores y mi sonrisa esta cambiando increiblemente. Gracias Dr. Samuel!',
